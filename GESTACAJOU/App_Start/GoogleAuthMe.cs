...
namespace GESTACAJOU.App_Start
{
    public class GoogleAuthMe : DotNetOpenAuth.AspNet.Clients.OAuth2Client
    {
         /// <summary>
        ...
        public GoogleAuthMe(string clientId, string clientSecret)
            : base("GooglePlus")
        {
            if (clientId == null)
        ...
        protected override Uri GetServiceLoginUrl(Uri returnUrl)
        {
           ...
           // uriBuilder.AppendQueryArgument("scope", "https://mail.google.com");
